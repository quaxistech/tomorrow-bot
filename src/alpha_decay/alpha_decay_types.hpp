...
enum class DecayRecommendation {
    ...
    SuspendStrategy,    ///< Приостановить стратегию (ожидание восстановления)
...
[[nodiscard]] inline std::string to_string(DecayRecommendation r) {
    switch (r) {
        ...
        case DecayRecommendation::SuspendStrategy:   return "SuspendStrategy";
...
struct DecayConfig {
    ...
    double health_suspend_threshold{0.15};      ///< Порог приостановки стратегии
