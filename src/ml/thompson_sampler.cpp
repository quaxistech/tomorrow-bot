...
{
    // EDGE-30-SIGNAL (run60 2026-05-15): убрали Skip arm — он автоматически пропускал
    // 20% сигналов в exploration. User wants максимум торговой активности на качественных
    // signals. Оставляем 4 arm — EnterNow + 3 Wait (delayed entry).
    arms_.resize(4);
