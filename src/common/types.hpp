...
enum class TradingMode {
    Paper,      ///< Бумажная торговля (симуляция без реальных денег)
    Shadow,     ///< Теневой режим (расчёты но без реального исполнения)
    Testnet,    ///< Тестовая сеть биржи (реальный API, тестовые деньги)
