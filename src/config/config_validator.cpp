...
void ConfigValidator::validate_pair_selection(
    ...
    if (cfg.rotation_interval_hours < 0.05 || cfg.rotation_interval_hours > 168) {
        result.add_error("pair_selection.rotation_interval_hours должен быть в диапазоне [0.05, 168] (3 min minimum)");
    }
