...
**Версия**: 0.3.0 | **Статус**: Production | **Тесты**: 293 тестов
...
**43+ модулей** · **5 стратегий** · **14 проверок риска** · **10 состояний FSM ордера** · **HTF тренд-фильтр** · **6 ML-модулей** · **Smart TWAP** · **Trailing Stop**
...
```bash
cd build-check
ctest --output-on-failure -j8   # 293 тестов
```
...
├── tests/                      # 293 теста (unit + integration + scenario)
