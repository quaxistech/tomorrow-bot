...
**43+ модулей** · **9 стратегий** · **27 проверок риска** · **10 состояний FSM ордера** · **HTF тренд-фильтр** · **6 ML-модулей** · **Smart TWAP** · **Trailing Stop**
...
| [Правила риска](docs/reference/risk_rules.md) | 27 проверок |
