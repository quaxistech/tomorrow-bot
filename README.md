...
**Версия**: 0.3.0 | **Статус**: Production | **Тесты**: 203/203
...
**42+ модулей** · **5 стратегий** · **14 проверок риска** · **10 состояний FSM ордера** · **HTF тренд-фильтр** · **6 ML-модулей** · **Smart TWAP** · **Trailing Stop**
